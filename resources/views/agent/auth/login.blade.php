        ...
        <div class="page-title hero-image" style="background-image: url({{ asset('uploads/bg/abstract-bg-3.webp') }}), radial-gradient(#ddd, #ccc);">
            <div class="heading">
                ...
                <div class="row d-flex justify-content-center text-center">
                    <div class="col-lg-8">
                    <h1 class="heading-title text-light">Agent Login</h1>
                                    ...
                                    <form action="{{ route('agent.login.submit') }}" method="post" autocomplete="off">
                                        ...
                                        <div class="mb-4 d-flex justify-content-between">
                                            ...
                                            <div class="forget-pass">
                                                <a href="{{ route('agent.forget.password') }}" class="text-secondary text-decoration-none">Forget Password?</a>
                                            </div>
                                        </div>
                                        <div class="col-12 mb-4">
                                        ...
                                        <div class="sign-up-link text-center">
                                            <p class="m-0">
                                                Don't Have an Account? Please <a href="{{ route('agent.registration') }}" class="text-decoration-none fw-bold">Sign Up</a>
                                            </p>
                                        </div>
                                    </form>
                                </div>
