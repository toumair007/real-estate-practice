                ...
                <div class="col-md-3">
                    <div class="card user-profile-card-left abg-dark text-light">
                        <div class="card-body">
                            ...
                            <ul class="list-group unboardered-list-group mb-3">
                            ...
                            <a href="{{ route('admin.profile.edit') }}" class="btn btn-primary btn-block fw-blod">Edit Profile</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <form action="">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" readonly class="form-control-plaintext" id="staticName" value="{{ Auth::guard('admin')->user()->name }}">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="staticEmail" class="col-sm-2 col-form-label">Email</label>
                                    <div class="col-sm-10">
                                        <input type="email" readonly class="form-control-plaintext" id="staticEmail" value="{{ Auth::guard('admin')->user()->email }}">
                                    </div>
                                </div>
                                <div class="mb-3 row">
