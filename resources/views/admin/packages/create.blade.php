        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item active">Create Packages</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form action="{{ route('admin.package.store') }}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" name="allowed_days" class="form-control" id="days" value="{{ old('allowed_days') }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="allowed_properties" class="form-label">Allowed Properties <span>*</span></label>
                                    <input type="number" name="allowed_properties" class="form-control" id="allowed_properties" value="{{ old('allowed_properties') }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="allowed_f_properties" class="form-label">Allowed Featured Properties <span>*</span></label>
                                    <input type="number" name="allowed_f_properties" placeholder="Allowed Featured Properties" class="form-control" id="allowed_f_properties" value="{{ old('allowed_f_properties') }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="allowed_photos" class="form-label">Allowed Photos <span>*</span></label>
                                    <input type="number" name="allowed_photos" placeholder="Allowed Photos" class="form-control" id="allowed_photos" value="{{ old('allowed_photos') }}">
                                </div>
                                <div class="col-12 col-md-6 mb-3">
                                    <label for="allowed_videos" class="form-label">Allowed Videos <span>*</span></label>
                                    <input type="number" name="allowed_videos" placeholder="Allowed Videos" class="form-control" id="allowed_videos" value="{{ old('allowed_videos') }}">
                                </div>
                            </div>
                            <div class="row">
