        ...
        <div class="page-title hero-image" style="background-image: url({{ asset('uploads/bg/abstract-bg-3.webp') }}), radial-gradient(#ddd, #ccc);">
            <div class="heading">
                <div class="container">
                    <div class="row d-flex justify-content-center text-center">
                        <div class="col-lg-8">
                            <h1 class="heading-title text-light">Customer Registration</h1>
            ...
            <nav class="breadcrumbs shadow">
                ...
                <ol>
                    ...
                    <li class="current">Customer Registration</li>
                </ol>
                </div>
            </nav>
        </div>
                ...
                <div class="row rounded-2 px-4 py-5 abg-light shadow">
                    ...
                    <div class="col-lg-6 align-self-center">
                        <div class="neumorphic-card mx-auto">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <form action="{{ route('registration.submit') }}" method="post" autocomplete="off">
                                        @csrf

                                        <div class="mb-4">
                                            <label for="name" class="form-label">Name <span class="text-danger">*</span></label>
                                            <input type="name" name="name" class="form-control neumorphic-input" id="name" placeholder="Enter Your Name" value="{{ old('name') }}">
                                        </div>
                                        <div class="mb-4">
