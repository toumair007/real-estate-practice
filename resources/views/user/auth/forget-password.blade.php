        ...
        <div class="heading">
            <div class="container">
                <div class="row d-flex justify-content-center text-center">
                    <div class="col-lg-8">
                        <h1 class="heading-title text-light">Customer Forget Password</h1>
        ...
        <div class="container d-flex justify-content-center align-items-center">
            <div class="row">
                <div class="neumorphic-card forget-box">
                    ...
                    <div class="col-12">
                        <form action="{{ route('forget.password.submit') }}" method="post">
                            ...
                            <div class="sign-up-link text-center">
                                <p class="m-0">
                                    Don't Have an Account? <a href="{{ route('registration') }}" class="text-decoration-none fw-bold">Sign Up</a>
                                </p>
                            </div>
                        </form>
                    </div>
                    ...
                    <!-- End Divider -->
                     <div class="col-12">
                        <a href="{{ route('login') }}" class="btn neumorphic-btn w-100">
                            Back to Login Page
                        </a>
                    </div>
                </div>
