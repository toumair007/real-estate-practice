            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="image-stack">
                        ...
                        <img src="{{ asset('uploads/real-estate/property-exterior-3.webp') }}" alt="Luxury Property" class="img-fluid">
                        ...
                        <img src="{{ asset('uploads/real-estate/property-interior-7.webp') }}" alt="Property Interior" class="img-fluid">
                        </div>

                        <div class="floating-card">
                        <div class="agent-info">
                            <img src="{{ asset('uploads/real-estate/agent-4.webp') }}" alt="Agent" class="agent-avatar">
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="col-lg-6 order-lg-2" data-aos="fade-left" data-aos-delay="200">
                    ...
                    <div class="main-image-wrapper">
                        <img src="{{ asset('uploads/real-estate/property-exterior-7.webp') }}" alt="Premium Property" class="img-fluid main-image">
                        <div class="floating-card">
                    ...
                    <div class="secondary-images">
                        ...
                        <img src="{{ asset('uploads/real-estate/property-interior-8.webp') }}" alt="Interior Design" class="img-fluid">
                        </div>
                        <div class="small-image">
                        <img src="{{ asset('uploads/real-estate/agent-3.webp') }}" alt="Expert Agent" class="img-fluid">
                        </div>
                    </div>
                    </div>
                </div>
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <article class="highlight-card">
                    ...
                    <a href="property-details.html" class="image-link">
                        <img src="{{ asset('uploads/real-estate/property-exterior-6.webp') }}" alt="Showcase Villa" class="img-fluid">
                    </a>
                ...
                <div class="mini-list">
                    ...
                    <a href="property-details.html" class="thumb">
                        <img src="{{ asset('uploads/real-estate/property-interior-2.webp') }}" alt="Loft Haven" class="img-fluid" loading="lazy">
                    ...
                    <a href="property-details.html" class="thumb">
                        <img src="{{ asset('uploads/real-estate/property-exterior-3.webp') }}" alt="Suburban Home" class="img-fluid" loading="lazy">
                    ...
                    <a href="property-details.html" class="thumb">
                        <img src="{{ asset('uploads/real-estate/property-interior-7.webp') }}" alt="Penthouse" class="img-fluid" loading="lazy">
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <figure class="stack-media">
                        <img src="{{ asset('uploads/real-estate/property-exterior-8.webp') }}" alt="Modern Facade" class="img-fluid" loading="lazy">
                        <figcaption>
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="350">
                    <article class="stack-card">
                    <figure class="stack-media">
                        <img src="{{ asset('uploads/real-estate/property-interior-10.webp') }}" alt="Cozy Interior" class="img-fluid" loading="lazy">
                        <figcaption>
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="400">
                    <article class="stack-card">
                    <figure class="stack-media">
                        <img src="{{ asset('uploads/real-estate/property-exterior-10.webp') }}" alt="Garden Home" class="img-fluid" loading="lazy">
                        <figcaption>
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="col-lg-6 col-xl-4" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="agent-image">
                        <img src="{{ asset('uploads/real-estate/agent-5.webp') }}" alt="Top Agent" class="img-fluid">
                ...
                <div class="col-lg-6 col-xl-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="agent-card">
                    <div class="agent-image">
                        <img src="{{ asset('uploads/real-estate/agent-4.webp') }}" alt="Top Agent" class="img-fluid">
                        <div class="agent-overlay">
                        <div class="contact-buttons">
                ...
                <div class="col-lg-6 col-xl-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="agent-card">
                    <div class="agent-image">
                        <img src="{{ asset('uploads/real-estate/agent-8.webp') }}" alt="Top Agent" class="img-fluid">
                        <div class="agent-overlay">
                        <div class="contact-buttons">
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="col-lg-6 col-xl-4" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="agent-info">
                        ...
                        <a href="agent-profile.html" class="profile-link">View All Properties</a>
                    </div>
                    </div>
                </div>
                <!-- End Agent Card -->
                ...
                <div class="col-lg-6 col-xl-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="agent-card">
                    <div class="agent-image">
                        <img src="{{ asset('uploads/real-estate/agent-7.webp') }}" alt="Top Agent" class="img-fluid">
                    </div>
                    <div class="agent-info">
                        <div class="agent-meta">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="testimonial-item">
                        ...
                        <div class="col-lg-8">
                            ...
                            <img src="{{ asset('uploads/person/person-m-7.webp') }}" class="profile-img" alt="">
                        ...
                        <div class="col-lg-4 d-none d-lg-block">
                            ...
                            <img src="{{ asset('uploads/person/person-m-7.webp') }}" class="featured-img" alt="">
                            </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="testimonial-item">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="profile d-flex align-items-center">
                            <img src="{{ asset('uploads/person/person-f-8.webp') }}" class="profile-img" alt="">
                            <div class="profile-info">
                                <h3>Sara Wilsson</h3>
                                <span>Designer</span>
                            </div>
                        ...
                        <div class="col-lg-4 d-none d-lg-block">
                            <div class="featured-img-wrapper">
                            <img src="{{ asset('uploads/person/person-f-8.webp') }}" class="featured-img" alt="">
                            </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="testimonial-item">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="profile d-flex align-items-center">
                            <img src="{{ asset('uploads/person/person-m-9.webp') }}" class="profile-img" alt="">
                            <div class="profile-info">
                                <h3>Matt Brandon</h3>
                        ...
                        <div class="col-lg-4 d-none d-lg-block">
                            <div class="featured-img-wrapper">
                            <img src="{{ asset('uploads/person/person-m-9.webp') }}" class="featured-img" alt="">
                            </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="testimonial-item">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="profile d-flex align-items-center">
                            <img src="{{ asset('uploads/person/person-f-10.webp') }}" class="profile-img" alt="">
                            <div class="profile-info">
                                <h3>Jena Karlis</h3>
                        ...
                        <div class="col-lg-4 d-none d-lg-block">
                            <div class="featured-img-wrapper">
                            <img src="{{ asset('uploads/person/person-f-10.webp') }}" class="featured-img" alt="">
                            </div>
                        </div>
                        </div>
                    </div>
        ...
        <section id="why-us" class="why-us section">
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="col-lg-5" data-aos="fade-right" data-aos-delay="200">
                    ...
                    <div class="main-image-wrapper">
                        <img src="{{ asset('uploads/real-estate/property-exterior-3.webp') }}" alt="Premium Property" class="img-fluid main-image">
            ...
            <div class="container">
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="post-img position-relative overflow-hidden">
                        <img src="{{ asset('uploads/blog/blog-post-1.webp') }}" class="img-fluid" alt="">
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="post-img position-relative overflow-hidden">
                        <img src="{{ asset('uploads/blog/blog-post-2.webp') }}" class="img-fluid" alt="">
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="post-img position-relative overflow-hidden">
                        <img src="{{ asset('uploads/blog/blog-post-3.webp') }}" class="img-fluid" alt="">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 order-2 order-lg-1" data-aos="fade-right" data-aos-delay="200">
                        <div class="cta-content">
                            ...
                            <p>
                                Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Mauris viverra veniam sit amet lacus cursus. Sed ut perspiciatis unde omnis iste natus error sit voluptatem.
                            </p>
                    ...
                    <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="250">
                        <div class="cta-visual">
                            <div class="main-image">
                                <img src="{{ asset('uploads/real-estate/property-exterior-5.webp') }}" alt="Property Investment" class="img-fluid">
