...
<head>
  ...
  <title>Home - TheProperty Bootstrap Template</title>
  <meta name="description" content="">
  <meta name="keywords" content="">

  <!-- Favicons -->
  <link href="{{ asset('uploads/favicon.png') }}" rel="icon">
  <link href="{{ asset('uploads/apple-touch-icon.png') }}" rel="apple-touch-icon">
